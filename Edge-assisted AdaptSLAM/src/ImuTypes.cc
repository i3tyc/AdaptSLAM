...
////////////////////////CommSLAM/////////////////////////////
Preintegrated::Preintegrated():dT(0.0f)
{
    Eigen::Matrix<float,15,15> C1;
    C1.setZero();
    C = C1;
    Eigen::Matrix<float,15,15> Info1;
    Info1.setZero();
    Info = Info1;
    Eigen::DiagonalMatrix<float,6> Nga1;
    Nga1.setZero();
    Nga = Nga1;
    Eigen::DiagonalMatrix<float,6> NgaWalk1;
    NgaWalk1.setZero();
    NgaWalk =NgaWalk1;
    b = IMU::Bias();
    dR = Eigen::Matrix3f::Zero();
    dV = Eigen::Vector3f();
    dP = Eigen::Vector3f();
