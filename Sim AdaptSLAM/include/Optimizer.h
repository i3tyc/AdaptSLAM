...
public:
    ...
    /////////////////////////////CommSLAM/////////////////////////////////////////////
    void static GlobalBundleAdjustemnt(Map* pMap, Uncertainty *pUncertainty, bool bIsLoopClosing = true, int nIterations=5, bool *pbStopFlag=NULL,
                                       const unsigned long nLoopKF=0, const bool bRobust = true);
    ////////////////////////////CommSLAM////////////////////////////////////////////////
    void static FullInertialBA(Map *pMap, Uncertainty *pUncertainty, int its, const bool bFixLocal=false, const unsigned long nLoopKF=0, bool *pbStopFlag=NULL, bool bInit=false, float priorG = 1e2, float priorA=1e6, Eigen::VectorXd *vSingVal = NULL, bool *bHess=NULL);

    ///////////////////////////////////CommSLAM/////////////////////////////////////////////////////
    void static LocalBundleAdjustment(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, Uncertainty *pUncertainty, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges);
    void static EdgeBundleAdjustment(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, Uncertainty *pUncertainty, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges);
    ...
    //////////////////////////////////CommSLAM////////////////////////////////////////////////
    void static LocalInertialBA(KeyFrame* pKF, bool *pbStopFlag, Map *pMap, Uncertainty *pUncertainty, int& num_fixedKF, int& num_OptKF, int& num_MPs, int& num_edges, bool bLarge = false, bool bRecInit = false);
    ...
    ////////////////////////CommSLAM//////////////////////////////////
    void static LocalBundleAdjustment(KeyFrame* pMainKF,vector<KeyFrame*> vpAdjustKF, vector<KeyFrame*> vpFixedKF, Uncertainty* pUncertainty, bool *pbStopFlag);
